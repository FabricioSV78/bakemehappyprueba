...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(180deg,rgba(255,248,243,0.05)_0%,rgba(255,248,243,0.18)_30%,rgba(255,248,243,0.94)_61%,rgba(255,248,243,0.99)_100%)] sm:bg-[linear-gradient(90deg,rgba(255,248,243,0.99)_0%,rgba(255,248,243,0.96)_31%,rgba(255,248,243,0.68)_53%,rgba(255,248,243,0.12)_78%,rgba(255,248,243,0.03)_100%)]" />
